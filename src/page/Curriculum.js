          ...
          <div className="currInfoWrapper">
            ...
            {/* <div className="currLearnInfo1">
              ...
              <div className="currLearnInfo1">
                ...
                <div className="currLearnDis">
                  <p>욕창은 피부나 접착 부위에 생긴 상처가 압력이나 마찰로 악화하는 상태를 말합니다. 주로 침대에 오래 누워 있는 환자나 휠체어를 사용하는 사람들에게 발생합니다.<br />침구를 교체하거나 체액 공급을 유지하는 등의 예방 조치와 적절한 상처 관리가 중요합니다.</p>
                </div>
                </div>
                <div className="currLearnButtonWrapper">
              ...
              <div className="currLearnInfo1">
                ...
                <div className="currLearnDis">
                  <p>유치 도뇨는 일반적으로 어린이나 희귀한 경우에는 성인에서 발생하는 방광 통제 장애입니다.<br />이는 방광 근육이 예기치 않게 수축하여 소변을 방출하는 것을 제어하지 못할 때 발생합니다.<br />이러한 상황은 일상생활에서 사회적, 정서적, 심리적으로 어려움을 겪을 수 있으며, 일부 사람들은 이를 '요실금'이라고도 부릅니다.<br />치료에는 행동요법, 약물요법, 수술 등이 있으며, 각 환자의 상황에 맞게 맞춤형 치료가 필요합니다.</p>
                </div>
                </div>
                <div className="currLearnButtonWrapper">
              ...
              <div className="currLearnInfo1">
                ...
                <div className="currLearnDis">
                  <p>단순 도뇨는 신장에서 요가 생성되지만, 필요한 성분을 충분히 함유하지 않는 상태를 말합니다. 이는 신장 기능 저하나 질환으로 인해 발생할 수 있습니다.<br />주로 소변량이 증가하거나 요의 색이 변화하는 증상을 보이며, 신장 질환의 진단과 관리가 필요합니다.</p>
                </div>
                </div>
                <div className="currLearnButtonWrapper">
