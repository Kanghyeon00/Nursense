        ...
        <div className="currWrapper">
          <div className="currInfoWrapper">
            <div className="currNameBar">
              <span>{" "}
              {selectedLanguage === "ko" ? "사전학습" : "Pre-learning"}</span>
            </div>
            ...
            {/* <div className="currLearnInfo1">
              ...
              <div className="currLearnInfo1">
                ...
                <div className="currLearnTitle">
                  <span>{" "}
              {selectedLanguage === "ko" ? "지역사회간호학" : "Community Health Nursing"}</span>
                  <span>{" "}
              {selectedLanguage === "ko" ? "욕창" : "Pressure ulcer"}</span>
                </div>
                <div className="currLearnDate">
                  <span>{" "}
              {selectedLanguage === "ko" ? "등록일" : "Registration Date"}</span>
                  <span>I</span>
                  <span>2023.10.10</span>
                </div>
                <div className="currLearnDis">
              ...
              {selectedLanguage === "ko" ? "지역사회간호학" : "Community Health Nursing"}</span>
                  <span>{" "}
              {selectedLanguage === "ko" ? "당뇨" : "Diabetes"}</span>
                </div>
                <div className="currLearnDate">
                  <span>{" "}
              {selectedLanguage === "ko" ? "등록일" : "Registration Date"}</span>
              ...
              {selectedLanguage === "ko" ? "지역사회간호학" : "Community Health Nursing"}</span>
                  <span>{" "}
              {selectedLanguage === "ko" ? "유치도뇨" : "Pediatric Urology"}</span>
                </div>
                <div className="currLearnDate">
                  <span>{" "}
              {selectedLanguage === "ko" ? "등록일" : "Registration Date"}</span>
              ...
              {selectedLanguage === "ko" ? "지역사회간호학" : "Community Health Nursing"}</span>
                  <span>{" "}
              {selectedLanguage === "ko" ? "단순도뇨" : "Simple Urology"}</span>
                </div>
                <div className="currLearnDate">
                  <span>{" "}
              {selectedLanguage === "ko" ? "등록일" : "Registration Date"}</span>
                ...
                <div className="currLearnDis">
                  <p>{" "}
              {selectedLanguage === "ko" ? "단순 도뇨는 신장에서 요가 생성되지만, 필요한 성분을 충분히 함유하지 않는 상태를 말합니다.\n이는 신장 기능 저하나 질환으로 인해 발생할 수 있습니다.\n주로 소변량이 증가하거나 요의 색이 변화하는 증상을 보이며, 신장 질환의 진단과 관리가 필요합니다." : "Simple diuresis refers to a condition where urine is produced in the kidneys but lacks sufficient components.\nThis can occur due to impaired kidney function or certain diseases.\nSymptoms typically include increased urine volume or changes in urine color, necessitating diagnosis and management of kidney disorders."}</p>
                </div>
                </div>
                <div className="currLearnButtonWrapper">
              ...
              {selectedLanguage === "ko" ? "지역사회간호학" : "Community Health Nursing"}</span>
                  <span>{" "}
              {selectedLanguage === "ko" ? "근육주사" : "Intramuscular Injection"}</span>
                </div>
                <div className="currLearnDate">
                  <span>{" "}
              {selectedLanguage === "ko" ? "등록일" : "Registration Date"}</span>
                ...
                <div className="currLearnDis">
                  <p>{" "}
              {selectedLanguage === "ko" ? "근육주사는 의료용 약물을 근육 내에 주입하는 치료 방법입니다.\n주로 통증 완화, 염증 감소, 근육의 이완, 혹은 약물의 효과를, 근육을 통해 빠르게 전달하기 위해 사용됩니다.\n이 방법은 비교적 간단하고 효과가 빠르며, 특정 부위에 직접 약물을 전달할 수 있어 다양한 의료 상황에서 사용됩니다." : "Intramuscular injection is a therapeutic method of administering medical drugs into the muscle tissue.\nIt is primarily used for pain relief, reducing inflammation, muscle relaxation, or rapidly delivering the effects of medicationthrough the muscles.\nThis method is relatively simple and fast-acting, allowing direct delivery of drugs to specific areas, making it suitable for various medical situations."}</p>
                </div>
                </div>
                <div className="currLearnButtonWrapper">
